...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/cucumber-7.x-2DD4BF?style=flat-square&labelColor=0C1018&color=2DD4BF" alt="cucumber"/>
</p>

<br/>

**KTestify** is an open-source, modular testing framework for [Apache Kafka](https://kafka.apache.org/) and Kafka Streams. It lets you write expressive, reliable stream tests — from low-level message assertions using a fluent Java API, all the way up to full BDD scenarios described in plain Gherkin.
...
A **standalone BDD test runner**. Uses Cucumber 7 + Gherkin to express Kafka stream scenarios in plain language, backed by the ktestify-core API.
...
KTestify enforces a strict three-layer separation so that transports, orchestration logic, and assertion strategies are completely decoupled. `ConsumedRecord<V>` is the **only data type that crosses layer boundaries**.
...
All values can also be set via environment variables (`KTESTIFY_KAFKA_BOOTSTRAP_SERVERS`, `KTESTIFY_SCHEMA_REGISTRY_URL`, `KTESTIFY_TOPIC_NAMESPACE`, `KTESTIFY_ASSETS_DIR`, …).
...
| Language | Java | 25 |
| Build | Maven | — |
| Config | Typesafe Config (HOCON) | 1.4.6 |
| Kafka client | Apache Kafka clients | 4.2.0 |
| Avro / Schema Registry | Confluent | 8.2.0 |
| BDD runner | Cucumber Java | 7.34.3 |
| DI (Cucumber) | cucumber-picocontainer | 7.34.3 |
| Reporting | cucumber-reportr | 1.1.0 |
| Integration containers | Testcontainers | 2.0.4 |
| Unit tests | JUnit 5 | 6.1.0-M1 |
...
|---|---|---|
| [ktestify-core](https://github.com/ktestify/ktestify-core) | 🟢 Active | `0.0.1-SNAPSHOT` |
| [ktestify-cucumber](https://github.com/ktestify/ktestify-cucumber) | 🟢 Active | `0.0.1-SNAPSHOT` |
...
KTestify is licensed under the [Apache License 2.0](LICENSE).
